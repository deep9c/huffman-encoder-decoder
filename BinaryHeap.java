...
public class BinaryHeap {
    ...
    public BinaryHeap(Vector<FrequencyTableElem> items) {
    ...
    public FrequencyTableElem extractMin() {
        ...
        if (list.size() == 0) {
        	...
        	FrequencyTableElem min = list.remove(0);
            return min;
        }

        // remove the last item ,and set it as new root
        FrequencyTableElem min = list.get(0);
        ...
        /*System.out.println();
        System.out.println("**** Min Heap extract *****");
		for(FrequencyTableElem ff:list){
			System.out.print("***"+ff+"***");
		}*/
